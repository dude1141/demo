...
(spark.table("author_counts_tmp_vw")
      ...
      .option("path", "dbfs:/user/hive/warehouse/author_counts")
      .format("delta")
      .start()
)
...
(spark.table("author_counts_tmp_vw")
      ...
      .outputMode("complete")
      .option("checkpointLocation", "dbfs:/mnt/Demo/author_counts_checkpoint")
      .option("path", "dbfs:/user/hive/warehouse/author_counts_new")
      .format("delta")
      .outputMode("complete")
      .start()
)
